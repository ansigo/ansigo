...
github.com/ansigo/compat.six import string_types
github.com/ansigo/compat.six.moves import configparser
github.com/ansigo/errors import AnsibleOptionsError
github.com/ansigo/module_utils._text import to_text
github.com/ansigo/parsing.quoting import unquote
github.com/ansigo/utils.path import makedirs_safe

)

BOOL_TRUE = frozenset([ "true", "t", "y", "1", "yes", "on" ])

func mk_boolean(value) ret:
...
# '''
func shell_expand(path, expand_relative_paths=False) path:
...
#     default is False.
# '''
func get_config(p, section, key, env_var, default, value_type=None, expand_relative_paths=False):


# ''' helper function for get_config '''
func _get_config(p, section, key, env_var, default):
